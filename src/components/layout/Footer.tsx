...
const footerLinks = {
  services: [
    { name: 'Thème Astral', href: '/astrologie/theme-natal' },
    { name: 'Tirage de Cartes', href: '/voyance/tirage' },
    { name: 'Horoscope', href: '/astrologie/horoscope' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-sm text-[var(--color-text-muted)] leading-relaxed">
              Votre guide spirituel en ligne. Astrologie, tarot et méditations pour éclairer votre chemin.
            </p>
          </div>
