        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <Link href="/" className="flex items-center gap-2 group z-10">
              <div className={`w-8 h-8 sm:w-9 sm:h-9 rounded-sm flex items-center justify-center transition-all ${
                isScrolled || !isHomePage
            ...
            <button
              ...
              className={`md:hidden p-2 -mr-2 rounded-sm transition-colors z-10 ${
                isMobileMenuOpen
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between p-4 border-b border-[var(--color-border)]">
            ...
            <button
              onClick={() => setIsMobileMenuOpen(false)}
              className="p-2 -mr-2 rounded-sm text-[var(--color-text-muted)] hover:text-[var(--color-text-primary)] hover:bg-[var(--color-bg-tertiary)]"
          ...
          <div className="p-4">
            ...
            <div className="space-y-3">
              <div className="px-4 py-3 rounded-sm bg-gradient-to-r from-[var(--color-primary)]/10 to-[var(--color-secondary)]/10">
